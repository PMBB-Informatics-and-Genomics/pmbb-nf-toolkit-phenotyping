...
CATEGORICAL_CONCEPTS = {'categorical', 'survey', 'demographic', 'demographics'}
...
def _legacy_main():
    ...
    if 'concept' not in df.columns:
        print("WARNING: No 'concept' column found. Processing all rows as categorical.",
              file=sys.stderr)
        cat_df = df.copy()
    else:
        cat_mask = df['concept'].str.lower().isin(CATEGORICAL_CONCEPTS)
